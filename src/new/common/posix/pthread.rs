...
extern "C" {
    ...
    #[cfg(any(target_os = "android", target_os = "l4re", target_os = "linux", target_os = "runixos"))]
    ...
    #[cfg(any(target_os = "l4re", target_os = "linux", target_os = "runixos", target_vendor = "apple"))]
    ...
    #[cfg(any(target_os = "l4re", all(any(target_os = "linux", target_os = "runixos"), not(target_env = "ohos"))))]
    pub fn pthread_cancel(thread: crate::pthread_t) -> c_int;

    #[cfg(any(target_os = "android", target_os = "emscripten", target_os = "linux", target_os = "runixos",))]
    ...
    #[cfg(all(any(target_os = "linux", target_os = "runixos"), not(target_env = "ohos")))]
    ...
    #[cfg(any(target_os = "l4re", target_os = "linux", target_os = "runixos"))]
